BX.namespace('Selector.UiSelector')

/**
 * Плагин для создания объекта TagSelector на базе статического списка
 * @type {{createTagSelector: BX.Selector.UiSelector.createTagSelector, renderTagSelector: BX.Selector.UiSelector.renderTagSelector}}
 */
BX.Selector.UiSelector = {
    /**
