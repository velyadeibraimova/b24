...
// Анастасия Бурнышева
// Запись на процедуры тип ReservationField
// $eventManager->AddEventHandler(
//     'iblock', 
//     'OnIBlockPropertyBuildList', 
//     [
//         'UserTypes\ReservationField', // класс обработчик пользовательского типа UF поля
//         'GetUserTypeDescription'
//     ]
// );
...
//     'OnIBlockPropertyBuildList',
//     [
//         'UserTypes\IBLinkReservationField', // класс обработчик пользовательского типа свойства 
//         'GetUserTypeDescription'
//     ]
// );